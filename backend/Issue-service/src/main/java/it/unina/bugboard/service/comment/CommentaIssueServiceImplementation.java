...
@Service
@Transactional
public class CommentaIssueServiceImplementation implements CommentaIssueService {
    private final RepositoryCommento commentoRepository;
    private final RepositoryIssueService issueRepository;

    @Autowired
    public CommentaIssueServiceImplementation(RepositoryCommento commentoRepository,
            RepositoryIssueService issueRepository) {
    ...
    public RispostaInserimentoCommentoIssue inserisciCommento(RichiestaInserimentoCommentoIssue richiesta,
        ...
        // Fallback se non riesce a ricaricare
        return new RispostaInserimentoCommentoIssue(true, "Commento inserito con successo", null);

    }

    private RispostaInserimentoCommentoIssue isRichiestaValida(RichiestaInserimentoCommentoIssue richiesta,
            Long userId) {
